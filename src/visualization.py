...
class Visualizer:
    ...
    def plot_audio_analysis(
        ...
        img1 = librosa.display.specshow(
            D, sr=sr, x_axis="time", y_axis="hz", ax=axes[0, 1]
        )
        ...
        img2 = librosa.display.specshow(
            mel_spec_db, sr=sr, x_axis="time", y_axis="mel", ax=axes[1, 0]
        )
    ...
    def plot_genre_distribution(
        self, df: pd.DataFrame, save_name: Optional[str] = None
    ) -> plt.Figure:
        """
    ...
    def plot_feature_distribution(
        self, df: pd.DataFrame, feature: str, save_name: Optional[str] = None
    ) -> plt.Figure:
        """
        ...
        ax.set_title(
            f"Distribution de '{feature}' par Genre", fontsize=14, fontweight="bold"
        )
        ax.set_xlabel("Genre")
    ...
    def plot_feature_boxplots(
        self, df: pd.DataFrame, features: List[str], save_name: Optional[str] = None
    ) -> plt.Figure:
        """
        ...
        fig.suptitle(
            "Distribution des Caractéristiques par Genre",
            fontsize=16,
            fontweight="bold",
        )
        plt.tight_layout()
    ...
    def plot_pca_2d(
        ...
        ax.set_title(
            "Projection PCA des Genres Musicaux", fontsize=14, fontweight="bold"
        )
    ...
    def plot_tsne_2d(
        self, df: pd.DataFrame, perplexity: int = 30, save_name: Optional[str] = None
    ) -> plt.Figure:
        """
        ...
        tsne = TSNE(
            n_components=2, perplexity=perplexity, random_state=Config.RANDOM_STATE
        )
        ...
        ax.set_title(
            "Projection t-SNE des Genres Musicaux", fontsize=14, fontweight="bold"
        )
        ax.legend(title="Genre", bbox_to_anchor=(1.05, 1), loc="upper left")
    ...
    def plot_model_comparison(
        ...
        ax.set_title(
            f"Comparaison des Modèles ({metric})", fontsize=14, fontweight="bold"
        )
        ax.set_xlim(0, 1)
